...
// フロントエンド public/js/workflows.js の BUILTIN_WORKFLOWS と同期を保つこと
const BUILTIN_WF_MAP = {
  anima: {
    id: 'anima',
    name: 'AnimaHighSpeed (Preset)',
    wf_data: JSON.stringify({
