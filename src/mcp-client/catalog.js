...
// (任意プロセス起動を封じるため、stdioはカタログ選択+必須env入力のみを許可する)

// 008: PlainChat(026/029/031/032)からの逐語移植。npm依存のためrequire.resolveで解決する
...
// 自前実装(外部npm依存なし)のためrequire.resolveではなく素直なファイル存在確認で解決する
